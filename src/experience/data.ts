...
export const experiences: ReadonlyArray<Experience> = [
  {
    ...
    summary: [
      'Worked as an <strong>embedded Forward Deployed Engineer with the <a href="https://www.llamaindex.ai/" target="_blank" rel="noopener noreferrer">LlamaIndex</a> team</strong>, taking document-processing systems from prototype to production for enterprise clients (BP, EY, Guidehouse) and driving adoption of the <strong>LlamaCloud</strong> platform.',
      ...
      "<strong>Mentored the engineering team</strong>, led technical interviews, defined engineering standards for AI system design and deployment, and represented the company through public talks and internal workshops.",
    ],
